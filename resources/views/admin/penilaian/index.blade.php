            ...
            <tbody class="divide-y divide-[#F0E8F5]">
                ...
                <tr class="hover:bg-[#F5F0FF] transition-colors duration-100">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex flex-col items-center gap-1">
                            <div class="w-full bg-[#F0E8F5] rounded-full h-1.5 max-w-[120px]">
                                @php
                                    $pct = $totalKriteria > 0 ? round(($p->jumlah_dinilai / $totalKriteria) * 100) : 0;
                                @endphp
                    ...
                    <td class="px-4 py-3 text-center">
                        @if($p->sudah_dinilai)
                            <span class="px-2 py-0.5 rounded-full text-[10px] font-medium bg-green-50 text-green-600 border border-green-200">
                                Sudah Dinilai
                            </span>
                        @else
                            <span class="px-2 py-0.5 rounded-full text-[10px] font-medium bg-amber-50 text-amber-600 border border-amber-200">
                                Belum Dinilai
                            </span>
                        @endif
                    </td>
